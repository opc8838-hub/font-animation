...
function render() {
  ...
  grid.innerHTML = visible.map(([slug, zh, en, , categoryName]) => {
    ...
    const target = slug === "flash" ? "flash-scenes.html" : slug === "iconburst" ? "iconburst.html?v=20260824-32" : `${slug}.html`;
    const detail = slug === "flash" ? "13 个独立子风格" : categoryName;
    const preview = livePreviews.has(slug)
      ? `<iframe class="effect-live" title="${zh}实时预览" data-src="${slug}.html?preview=1&amp;v=20260824-32" loading="lazy" tabindex="-1"></iframe>`
