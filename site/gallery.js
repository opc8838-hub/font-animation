const effects = [
  ...
  ["sproutshift", "字芽", "Sprout Shift", "type", "逐字生长变形"],
  ["mistlift", "雾升", "Mist Lift", "type", "升散浮入"],
  ["typecascade", "字倾", "Type Cascade", "type", "倾倒坠落"],
  ...
  ["impactbuild", "冲击接句", "Impact Build", "type", "巨字冲击 · 横向拖影接句"],
  ...
  ["ribbonink", "流彩笔迹", "Ribbon Ink", "flow", "手写彩带纹理"],
...
const featuredPreviews = new Set(["textswell", "impactbuild", "currentwall", "verticalwall", "iconburst", "glyphmorph", "sproutshift", "mistlift", "typecascade", "dotresolve", "glyphreveal", "continuation", "beforeafter", "shutterafter", "pathwriter", "ribbonink", "scrapbin"]);
...
function render() {
  ...
  grid.innerHTML = visible.map(([slug, zh, en, , categoryName]) => {
    ...
    const target = slug === "flash" ? "flash-scenes.html" : slug === "iconburst" ? "iconburst.html?from=gallery&v=20260824-37" : slug === "glyphmorph" ? "glyphmorph.html?from=gallery&v=20260904-4" : slug === "dotresolve" ? "dotresolve.html?from=gallery&v=20260904-1" : ["sproutshift", "mistlift", "typecascade", "glyphreveal"].includes(slug) ? `${slug}.html?from=gallery&v=20260904-4` : slug === "continuation" ? "continuation.html?from=gallery&v=20260904-center1" : slug === "currentwall" ? "currentwall.html?from=gallery&v=20260830-28" : slug === "verticalwall" ? "verticalwall.html?from=gallery&v=20260901-57" : slug === "beforeafter" ? "beforeafter.html?from=gallery&v=20260825-latest1" : slug === "shutterafter" ? "shutterafter.html?from=gallery&v=20260827-1" : slug === "pathwriter" ? "pathwriter.html?from=gallery&v=20260827-default2" : slug === "ribbonink" ? "ribbonink.html?from=gallery&v=20260904-8" : slug === "impactbuild" ? "impactbuild.html?from=gallery&v=20260901-final2" : slug === "scrapbin" ? "scrapbin.html?from=gallery&v=20260826-delete11" : slug === "liquidtype" ? "liquidtype.html?from=gallery&v=20260824-scatter3" : `${slug}.html`;
    ...
    const preview = slug === "continuation"
      ...
      : slug === "dotresolve"
        ? `<video class="effect-loop" src="assets/previews/dotresolve-card.mp4?v=20260904-1" autoplay muted loop playsinline preload="metadata" aria-label="${zh}动态效果预览"></video>`
      : ["sproutshift", "mistlift", "typecascade", "glyphreveal"].includes(slug)
        ? `<video class="effect-loop" src="assets/previews/${slug}-wide-card.mp4?v=20260904-4" autoplay muted loop playsinline preload="metadata" aria-label="${zh}动态效果预览"></video>`
      : slug === "currentwall"
      ...
      : slug === "verticalwall"
        ? `<video class="effect-loop" src="assets/previews/vertical-rise-card.mp4?v=20260901-1" autoplay muted loop playsinline preload="metadata" aria-label="${zh}动态效果预览"></video>`
      : slug === "beforeafter"
      ...
      : slug === "ribbonink"
        ? `<video class="effect-loop" src="assets/previews/ribbon-ink-card.mp4?v=20260902-1" autoplay muted loop playsinline preload="metadata" aria-label="${zh}动态效果预览"></video>`
      : slug === "scrapbin"
      ...
      : slug === "impactbuild"
        ? `<video class="effect-loop" src="assets/previews/impactbuild-card.mp4?v=20260901-2" autoplay muted loop playsinline preload="metadata" aria-label="${zh}动态效果预览"></video>`
