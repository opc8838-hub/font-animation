(function () {
  const effects = [
    ...
    ["coil", "线圈", "Coil"], ["continuation", "续句", "Continuation"], ["currentwall", "流墙", "Current Wall"], ["verticalwall", "纵跃", "Vertical Rise"], ["creatorstudio", "汇聚", "Creator Merge"], ["focuswheel", "焦轮", "Focus Wheel"], ["colorrecompose", "彩组", "Color Recompose"], ["phrasebuild", "组句", "Phrase Build"], ["switchdrop", "降临", "Switch Drop"], ["pathwriter", "轨书", "Path Writer"], ["flag", "旗帜", "Flag"], ["morisawa", "森泽", "Morisawa"],
