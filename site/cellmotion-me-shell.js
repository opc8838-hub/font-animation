...
(() => {
  ...
  const header = make("header", "gm-header tc-header",
    `<a class="tc-brand" href="cellmotion.html" aria-label="CellMotion 首页"><img src="assets/cellmotion/logo-original-transparent.png?v=20260926-1" alt="CellMotion"></a><div><small>让创意，自由生长</small><h1>${zhName}${enName ? ` <span>${enName}</span>` : ""}</h1></div>`);
  body.prepend(header);
