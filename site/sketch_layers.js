...
function preload() {
  fontMenu = loadFont('assets/NotoSansSC-Regular.ttf');
  fontSelect1 = loadFont('assets/NotoSansSC-Regular.ttf');
  fontSelect2 = loadFont('assets/NotoSansSC-Regular.ttf');
  fontSelect3 = loadFont('assets/NotoSansSC-Regular.ttf');
  fontSelect4 = loadFont('assets/NotoSansSC-Regular.ttf');
  fontSelect5 = loadFont('assets/NotoSansSC-Regular.ttf');
  fontSelect6 = loadFont('assets/NotoSansSC-Regular.ttf');
  fontSelect7 = loadFont('assets/NotoSansSC-Regular.ttf');
...
function setup() {
  ...
  speedRacerSet = createButton('极速赛车'); speedRacerSet.position(25,height-160); speedRacerSet.mousePressed(speedRacer);
  goingMonoSet = createButton('太空'); goingMonoSet.position(25,height-140); goingMonoSet.mousePressed(toSpace);
  hangulSet = createButton('나선형의 것'); hangulSet.position(25,height-120); hangulSet.mousePressed(hangulSample);
  lostTimeSet = createButton('时光流逝'); lostTimeSet.position(25,height-100); lostTimeSet.mousePressed(lostTime);
  dotSpiralSet = createButton('点螺旋'); dotSpiralSet.position(25,height-80); dotSpiralSet.mousePressed(dotSpiral);
  beAggressiveSet = createButton('激进'); beAggressiveSet.position(25,height-60); beAggressiveSet.mousePressed(beAggressive);
  meatSpaceSet = createButton('肉空间'); meatSpaceSet.position(25,height-40); meatSpaceSet.mousePressed(meatSpace);
}
...
//              translate(k * sWidth - width,0);
  ...
  translate(-width/2, -height/2);
    text("层数" + stackCount,25,80);
    text("字号" + fontSize,25,110);
    text("内高 " + innerHSlider.value(),25,140);
    text("内宽 " + innerVSlider.value(),25,170);
    text("旋转 " + rotateFactorSlider.value(),25,200);
    text("前面",52,283);
    text("四分之一",52,302);
    text("向上 ",52,321);
    text("预设",25,height-170);
  pop();
}
